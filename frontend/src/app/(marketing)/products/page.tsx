                            ...
                            {qs.length > 0 && (
                              <div>
                                ...
                                <div className="space-y-2.5 text-muted-foreground">
                                  {qs.map((q, i) => (
                                    <div key={i} className="flex items-start gap-2">
                                      <span className="flex h-4 shrink-0 w-auto min-w-4 px-1 items-center justify-center rounded-[4px] bg-primary/15 text-[9px] font-bold text-primary mt-px">Q{i + 1}</span>
